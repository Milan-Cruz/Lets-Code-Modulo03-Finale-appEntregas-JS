...
const entregadoraSilvia = new Entregador('Silvia', '7318250943', 52520000, 5.0)
  ...
  console.log(mcDonalds.listarCardapio()) 
   ...
   /* console.log(entregadoraSilvia.aceitarPedido(1)) //pedido do Pedro
    console.log(entregadoraSilvia.entregaPedidoCliente(1)) //pode confirmar entrega depois do cliente confirmar recebimento
    console.log(entregadoraSilvia.fechaTurno())


    console.log('------------ Passo 5 -> Finalizando -------------')
    console.log(clientePedro.receberPedido())
    console.log(clientePedro)
    console.log(clientePedro)


//vai descomentando pra mostrar
//cada roteiro tem 2 versões:
//1ª com console.log, para visualizar
//2ª sem console.log, para apenas funcionsar

//iniciaLojista()
iniciaLojistaSemLog()
//iniciarCliente()
iniciarClienteSemLog()
iniciarLojista() // recusar com erro, decomentar cancelar para testar
//iniciarLojistaSemLog()
//finalizar()
...
const runCliente = () => {
    clientePedro.listarLojistas()
    clientePedro.escolherLojista(lojistaFausto)
    clientePedro.listarCardapio()
    clientePedro.adicionarItemCarrinho('Suco Detox')
    clientePedro.adicionarItemCarrinho('Pizza Calabresa')
    clientePedro.adicionarItemCarrinho('Sopa Verde')
    clientePedro.adicionarItemCarrinho('BigMac')
    clientePedro.removerItem('BigMac')
    clientePedro.gerarPedido()
    clientePedro.encaminharPedido()  
}

//runCliente()
//lojistaFausto.entrarNoApp()
//lojistaFausto.listarPedidosPendentes()



    

    //AppGerenciador.listaPendentes[0]
    //lojistaFausto.aceitarPedido(AppGerenciador.listaPendentes[0])


//clientePedro.cancelarPedido()
//entregadoraSilvia.abreTurno()
//entregadoraSilvia.aceitarPedido()


/* console.log(cardapioFausto.pratoExiste('Sopa Verde'))
console.log(lojistaFausto.pratoExisteCardapio('Sopa Verde')) */
//clientePedro.pratoExisteLojista(pizzaCalabresa)

//console.log(lojistaFausto.cardapio)
// console.log(clientePedro.lojista.cardapio.listaPratos.findIndex((element) => element.nome == 'Calabresa')) 

//console.log(clientePedro.pratoExisteLojista(sopaVerde))
//console.log(clientePedro.pratoExisteLojista(sucoDetox))
...
console.log('remover item3')
console.log('gerarPedido')
console.log('encaminharPedido\n')

console.log('aceitarPedido\n')

console.log('aceitarPedido\n')
console.log('entregarPedido')
console.log('receberPedidoEntregue')*/
